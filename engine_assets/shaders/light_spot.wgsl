// Deferred spot light: a point light constrained to a cone along
// direction_cone.xyz, with a smooth edge between the inner (color_cone.w) and
// outer (direction_cone.w) cone cosines.  Fullscreen triangle, additively
