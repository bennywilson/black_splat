...
use crate::{assets::*, config::*, game_object::*, resource::*, utils::*};

#[repr(C)]
#[derive(Copy, Clone, bytemuck::Pod, bytemuck::Zeroable)]
pub struct SunbeamInstance {
    pub pos_scale: [f32; 4],
}

impl SunbeamInstance {
    pub fn desc() -> wgpu::VertexBufferLayout<'static> {
        wgpu::VertexBufferLayout {
            array_stride: size_of::<SunbeamInstance>() as wgpu::BufferAddress,
...
impl SunbeamPass {
    pub async fn new(
        ...
        let sunbeam_uniform = SunbeamUniform {
            ..Default::default()
        };
        ...
        let draw_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                module: draw_shader,
                entry_point: Some("vs_main"),
                buffers: &[Vertex::desc(), SunbeamInstance::desc()],
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            fragment: Some(wgpu::FragmentState {
                module: draw_shader,
        ...
        let instance_buffer = device.create_buffer(&wgpu::BufferDescriptor {
            ...
            size: (size_of::<SunbeamInstance>() * 50_usize) as u64,
    ...
    pub fn render_beams(
        ...
        let mut beam_instances = Vec::<SunbeamInstance>::new();

        let mut scale = 1.0;
        for _ in 0..NUM_FLARE_STEPS {
            beam_instances.push(SunbeamInstance {
